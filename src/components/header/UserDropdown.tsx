...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="relative mr-3 overflow-hidden rounded-full h-11 w-11">
          {user?.avatar ? (
            <img
              src={user.avatar}
              alt={getDisplayName()}
            ...
            <div className="flex items-center justify-center w-full h-full bg-brand-500 text-white font-medium text-sm">
              {getInitials()}
            </div>
          )}
        </div>
